...
- [Frameworks / Runtimes-框架/运行时](#frameworks--runtimes)
- [Service Toolkits-服务工具箱](#service-toolkits)
  - [Polyglot-多语言](#polyglot)
  - [Java VM-Java](#java-vm)
  - [Node.js-Node](#nodejs)
  - [PHP-PHP](#php)
- [Capabilities-功能](#capabilities)
  - [API Gateways / Edge Services-网关层](#api-gateways--edge-services)
  - [Configuration and Discovery-配置管理和服务发现](#configuration-and-discovery)
  - [Coordination and Governance-协调管理](#coordination-and-governance)
  - [Elasticity-弹性](#elasticity)
  - [Job Schedulers / Workload Automation-工作计划/工作负载自动化](#job-schedulers--workload-automation)
  - [Logging-日志](#logging)
  - [Messaging-消息](#messaging)
  - [Monitoring and Debugging-监测/调试](#monitoring-and-debugging)
  - [Reactivity-响应](#reactivity)
  - [Resilience-弹性](#resilience)
...
- [Documentation & Modeling-文档/模型](#documentation--modeling)
  - [REST APIs-REST接口](#rest-apis)
- [Standards / Recommendations-标准建议](#standards--recommendations)
  ...
  - [Unicode](#unicode)
- [Real Life Stories-真实案例](#real-life-stories)
- [Theory-理论](#theory)
  - [Articles & Papers-文章/论文](#articles--papers)
  - [Talks-访谈](#talks)
  - [Tutorials-教程](#tutorials)
  - [Books-书籍](#books)
  - [Sites-网站](#sites)
- [Emerging Technologies-新兴技术](#emerging-technologies)
...
### API Gateways / Edge Services-网关层
...
### Configuration and Discovery-配置管理和发现
...
### Coordination and Governance-协调管理
...
### Job Schedulers / Workload Automation-工作计划
...
### Monitoring and Debugging-监控/调试
...
- [IOpipe ![c]](https://www.iopipe.com/) - Application performance monitoring for Amazon Lambda.
...
## Continuous Integration and Continuous Delivery-持续集成和持续部署
...
## Standards / Recommendations-标准和推荐
